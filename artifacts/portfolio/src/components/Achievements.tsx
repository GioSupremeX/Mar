...
const rarityStyle: Record<string, { bg: string; border: string; dot: string; label: string }> = {
  gold: { bg: "linear-gradient(135deg, rgba(232,212,168,0.35), rgba(248,230,160,0.18))", border: "rgba(200,168,80,0.35)", dot: "#B8900A", label: "gold" },
  silver: { bg: "linear-gradient(135deg, rgba(200,200,220,0.3), rgba(220,218,240,0.15))", border: "rgba(160,158,190,0.35)", dot: "#7878AA", label: "silver" },
  special: { bg: "linear-gradient(135deg, rgba(179,157,219,0.28), rgba(244,167,195,0.18))", border: "rgba(179,157,219,0.45)", dot: "#9D6ED8", label: "special" },
};
